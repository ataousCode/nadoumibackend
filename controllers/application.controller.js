...
class ApplicationController {
  ...
  getByStatus = asyncHandler(async (req, res) => {
    const applications = await applicationService.getByStatus(req.params.status)
    sendSuccess(res, applications)
  })

  getByScholarship = asyncHandler(async (req, res) => {
    const applications = await applicationService.getByScholarship(req.params.scholarshipId)
    sendSuccess(res, applications)
  })
  ...
  getStudentApplications = asyncHandler(async (req, res) => {
    const applications = await applicationService.getStudentApplications(req.student.id)
    sendSuccess(res, applications)
  })
  ...
  createApplication = asyncHandler(async (req, res) => {
    const application = await applicationService.createApplication(req.student.id, req.body)
